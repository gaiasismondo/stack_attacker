 ...
 *      Test suite file : suites/test_suite_cmac.function
 *      Test suite data : suites/test_suite_cmac.data
 *
 *
...
#line 12 "suites/test_suite_cmac.function"
...
#line 19 "suites/test_suite_cmac.function"
...
#line 102 "suites/test_suite_cmac.function"
...
#line 123 "suites/test_suite_cmac.function"
...
#line 200 "suites/test_suite_cmac.function"
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "mbedtls_cmac_self_test" ) == 0 )
    {
    #ifdef MBEDTLS_SELF_TEST
        ...
        test_suite_mbedtls_cmac_self_test(  );
    ...
    if( strcmp( params[0], "mbedtls_cmac_null_args" ) == 0 )
    {
        ...
        test_suite_mbedtls_cmac_null_args(  );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "mbedtls_cmac_setkey" ) == 0 )
    {
        ...
        test_suite_mbedtls_cmac_setkey( param1, param2, param3 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "mbedtls_cmac_multiple_blocks" ) == 0 )
    {
        ...
        test_suite_mbedtls_cmac_multiple_blocks( param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13 );
        return ( DISPATCH_TEST_SUCCESS );

        return ( DISPATCH_UNSUPPORTED_SUITE );
    }
    else
    if( strcmp( params[0], "mbedtls_cmac_multiple_operations_same_key" ) == 0 )
    {
        ...
        int param15;
        char *param16 = params[16];
        int param17;
        char *param18 = params[18];
        ...
        if( verify_string( &param16 ) != 0 ) return( DISPATCH_INVALID_TEST_DATA );
        if( verify_int( params[17], &param17 ) != 0 ) return( DISPATCH_INVALID_TEST_DATA );
        if( verify_string( &param18 ) != 0 ) return( DISPATCH_INVALID_TEST_DATA );

        test_suite_mbedtls_cmac_multiple_operations_same_key( param1, param2, param3, param4, param5, param6, param7, param8, param9, param10, param11, param12, param13, param14, param15, param16, param17, param18 );
        return ( DISPATCH_TEST_SUCCESS );
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "suites/test_suite_cmac.data";
