...
#line 7 "suites/test_suite_pem.function"
...
#ifdef MBEDTLS_MD5_C
#ifdef MBEDTLS_CIPHER_MODE_CBC
#line 38 "suites/test_suite_pem.function"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "suites/test_suite_pem.data";
