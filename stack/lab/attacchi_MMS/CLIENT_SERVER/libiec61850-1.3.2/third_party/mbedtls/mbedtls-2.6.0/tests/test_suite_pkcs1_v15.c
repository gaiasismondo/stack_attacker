...
#line 12 "suites/test_suite_pkcs1_v15.function"
...
#line 55 "suites/test_suite_pkcs1_v15.function"
...
#line 112 "suites/test_suite_pkcs1_v15.function"
...
#line 176 "suites/test_suite_pkcs1_v15.function"
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "pkcs1_rsaes_v15_decrypt" ) == 0 )
    {
    ...
    if( strcmp( params[0], "pkcs1_rsassa_v15_sign" ) == 0 )
    {
    ...
    if( strcmp( params[0], "pkcs1_rsassa_v15_verify" ) == 0 )
    {
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "suites/test_suite_pkcs1_v15.data";
