...
#line 11 "suites/test_suite_error.function"
...
int dispatch_test(int cnt, char *params[50])
{
    ...
    if( strcmp( params[0], "error_strerror" ) == 0 )
    {
        ...
        test_suite_error_strerror( param1, param2 );
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "suites/test_suite_error.data";
