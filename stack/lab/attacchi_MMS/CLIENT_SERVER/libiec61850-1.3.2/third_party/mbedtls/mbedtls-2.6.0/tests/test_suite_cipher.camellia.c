 ...
 *      Test suite data : suites/test_suite_cipher.camellia.data
 *
 *
...
#define USAGE \
    ...
    argv[0], \
    "suites/test_suite_cipher.camellia.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "suites/test_suite_cipher.camellia.data";
