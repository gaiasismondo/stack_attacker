...
int verify_int( char *str, int *value )
{
    ...
    if( strcmp( str, "MBEDTLS_GCM_ENCRYPT" ) == 0 )
    {
        *value = ( MBEDTLS_GCM_ENCRYPT );
        return( KEY_VALUE_MAPPING_FOUND );
    }
...
#line 11 "suites/test_suite_gcm.function"
...
#line 54 "suites/test_suite_gcm.function"
...
#line 105 "suites/test_suite_gcm.function"
...
#line 163 "suites/test_suite_gcm.function"
...
#define USAGE \
    ...
    argv[0], \
    "suites/test_suite_gcm.aes192_en.data"
...
int main(int argc, const char *argv[])
{
    ...
    const char *default_filename = "suites/test_suite_gcm.aes192_en.data";
