...
public class DBN_Model_complete {
    ...
    public DBN_Model_complete(File input, File script, File ris, File image, File csv) {
        this.input = input;
        this.script = script;
        this.ris = ris;
        this.image = image;
    ...
    public void runModel() {
        try{
            ProcessBuilder p = new ProcessBuilder("octave", "" + script, "" + input, "" + ris, "" + image, "" + csv);
